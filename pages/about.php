...
?>    
    <div class="content">
        ...
        <div class="series-pic-about-top">
            <img src="../images/eric-color-head-shot-319x400.jpg" width="319" height="400" alt="Eric Color Head Shot Image" />
        </div>
        ...
        <div class="bio">
            ...
            <div class="margin-bottom-1%" style="border: solid 1px red;">
            ...
            <div class="margin-bottom-1%">
                <span style="display: inline-block;margin-left: 5px;">I</span> have been writing stories since grade school. A few of my books were even confiscated in high school with a warning and 
		...
		<div class="series-pic-about-bottom">
			<img src="../images/wedding-302x400.jpg" width="302" height="400" alt="Eric and Leslie Koch Image" />
		</div>
	</div>  <!-- [end content div] -->
